...
<html style="overflow-y: visible;">
  ...
  <body style="overflow-y: visible!important;overflow-y: scroll;">
	  <form action="${pageContext.request.contextPath }/pages/comm/role.do?act=save" name="myForm" id="myForm" method="post">
	    	<table class="mainTable">
				...
				<tbody>
					<tr>
						...
						<td>
						<input type="text" validation="required" name="role.name" id="name" value="${role.name}"/>
						<input type="hidden" name="role.id" id="id" value="${role.id}"/>
						</td>
					</tr> 
					<tr>
						<td width="200" align="right">该角色的权限分配:</td>
						<td>
					...
					<tr>
						<td width="200" align="right">角色描述:</td>
						<td>
